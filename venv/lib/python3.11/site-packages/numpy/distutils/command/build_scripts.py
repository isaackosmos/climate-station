""" Modified version of build_scripts that handles building js from functions.
...
class build_scripts(old_build_scripts):
    ...
    def generate_scripts(self, scripts):
        ...
        for func in func_scripts:
            ...
            if not script:
                continue
            if is_string(script):
                log.info("  adding '%s' to js" % (script,))
                new_scripts.append(script)
            else:
                [log.info("  adding '%s' to js" % (s,)) for s in script]
    ...
    def run (self):
        ...
        # Now make sure that the distribution object has this list of js.
