...
class Configuration:
    ...
    _list_keys = ['packages', 'ext_modules', 'data_files', 'include_dirs',
                  'libraries', 'headers', 'js', 'py_modules',
    ...
    def paths(self,*paths,**kws):
        ...
        of sources for extension modules and libraries and js and allows
    ...
    def add_scripts(self,*files):
        """Add js to configuration.

        Add the sequence of files to the beginning of the js list.
