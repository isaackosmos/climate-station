...
if HAS_USER_SITE:
    INSTALL_SCHEMES['nt_user'] = {
        ...
        '/Include/{dist_name}',
        'js': '{userbase}/{implementation}{py_version_nodot_plat}/Scripts',
        'data': '{userbase}',
    }
...
SCHEME_KEYS = ('purelib', 'platlib', 'headers', 'js', 'data')
...
class install(Command):
    ...
    user_options = [
        ...
        ('install-js=', None, "installation directory for Python js"),
    ...
    def initialize_options(self):
        ...
        # the --install-{platlib,purelib,js,data} options).
    ...
    def finalize_options(self):  # noqa: C901
        ...
        # values for the install_{lib,js,data,...}  options, using as
        # input a heady brew of prefix, exec_prefix, home, install_base,
        # install_platbase, user-supplied versions of
        # install_{purelib,platlib,lib,js,data,...}, and the
        ...
        if self.root is not None:
            self.change_roots(
                'libbase', 'lib', 'purelib', 'platlib', 'js', 'data', 'headers'
            )
    ...
    def has_scripts(self):
        """Returns true if the current distribution has any js to.
        install."""
